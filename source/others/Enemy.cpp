...
Enemy::Enemy()
 {
	...
	hit_box->size = { 50,80 };
	hurt_box->size = { 100,100 };

	hit_box->layer_src = Collisionlayer::None;
	hit_box->layer_dst = Collisionlayer::Player;

	hurt_box->layer_src = Collisionlayer::Enemy;
	...
	collision_box_silk->layer_src = Collisionlayer::None;
	collision_box_silk->layer_dst=Collisionlayer::Player;
	collision_box_silk->size = { 225,225 };
	collision_box_silk->enabled=false;

	 {
		...
		animation_aim_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_aim_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		animation_dash_in_air_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_dash_in_air_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		animation_dash_on_floor_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_dash_on_floor_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		animation_squat_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_squat_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		animation_throw_barb_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_throw_barb_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		animation_throw_silk_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_throw_silk_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		animation_throw_sword_left.set_anchor_mode(Animation::anchorMode::bottomed);
		...
		animation_throw_sword_right.set_anchor_mode(Animation::anchorMode::bottomed);
	...
	}
	{
		...
		state_machine.register_state("dash_on_floor",   new EnemyDashOnFloor);
...
void Enemy::on_update(float delta)
{
	...
	hit_box->position=get_logic_center();
